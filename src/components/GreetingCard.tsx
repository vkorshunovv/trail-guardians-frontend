  ...
  return (
    <div className="greeting-card">
      <p>
        ...
        doloremque similique, ea unde repellendus, expedita quis iusto nesciunt
        nemo provident quia alias consequatur dolore, corporis quod placeat
        possimus illo enim!
      </p>
      <ul>
        <li>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus
          cupiditate esse, enim quis recusandae, ullam ipsa obcaecati officia
          voluptates doloribus soluta, ipsam vel modi! Minus facere non repellat
          ducimus molestias.
        </li>
        <li>
